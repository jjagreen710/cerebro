...
public class User {
	...
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable( name = "comic_wishlist",
				joinColumns = @JoinColumn(name = "user_id"),
				inverseJoinColumns = @JoinColumn(name = "comic_id"))
	private Set<Comic> comicWishlist = new HashSet<>();
	
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable( name = "collection_wishlist",
				joinColumns = @JoinColumn(name = "user_id"),
				inverseJoinColumns = @JoinColumn(name = "collection_id"))
	private Set<Collection> collectionWishlist = new HashSet<>();
